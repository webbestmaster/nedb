...
var executeAsap = cb => setTimeout(cb, 0);
...
module.exports.findDocs = function (d, n, profiler, cb) {
    ...
    function runFrom(i) {
        if (i === n) {
            // Finished
            console.log(
                '===== RESULT (find) ===== ' + Math.floor((1000 * n) / profiler.elapsedSinceLastStep()) + ' ops/s'
            );
...
module.exports.updateDocs = function (options, d, n, profiler, cb) {
    ...
    function runFrom(i) {
        if (i === n) {
            // Finished
            console.log(
                '===== RESULT (update) ===== ' + Math.floor((1000 * n) / profiler.elapsedSinceLastStep()) + ' ops/s'
            );
